var commonAction = function () {
  var n = !1, t = function () {
    var n = {
      _urlRoot: "", _traditional: !0, _doAjax: function (n, t, e, i) {
    ...
    initScreen: function (n) {
      ...
      $(".newsList").each(function (n, t) {
        ...
        var i, o = $(t), r = o.find("li"), a = 20, s = 4;
      ...
      Number.prototype.pad2 = function () {
        ...
        var t = new Date, t = this, e = t.getMonth() + 1, i = t.getHours(), o = t.getMinutes(), r = t.getDate(),
          a = t.getSeconds(), s = {
            yyyy: t.getFullYear(),
  ...
  return {browser: r, debug: a, remote: e, InitRemote: t, fn: o, init: s}
}(), ca = commonAction;
$(function () {
  commonAction.init()
});
